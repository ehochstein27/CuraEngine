...
static constexpr float max_non_bridge_line_volume = 1000000.0f; // limit to accumulated "volume" of non-bridge lines which is proportional to distance x extrusion rate
