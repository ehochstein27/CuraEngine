...
public:
    typedef std::function<short(std::vector<ExtrusionJunction>, std::vector<ExtrusionJunction>)> order_comp_t;
     ...
     */
    bool processInsetsOrdered(const order_comp_t& ordering);
